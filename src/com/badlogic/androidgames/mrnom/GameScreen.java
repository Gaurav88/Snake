...
import com.badlogic.androidgames.MainMenuScreen;
import com.badlogic.androidgames.Settings;
...
/*if(len>20){
	g.drawPixmap(Assets.line, 100, 150);
}*/
}
...
g.drawPixmap(Assets.black, 0, 416);
g.drawPixmap(Assets.buttons1, 0, 0);
g.drawLine(0, 416, 480, 416, Color.BLACK);
g.drawPixmap(Assets.buttonl, 0, 416);
g.drawPixmap(Assets.buttonr, 256, 416);
}
...
g.drawPixmap(Assets.cross, 128, 200);
g.drawLine(0, 416, 480, 416, Color.BLACK);
}
